<template>
  <main>
    <div
      class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-160"
      aria-hidden="true"
    >
      <div
    ...
    <div class="justify-center items-center h-full">
      <div class="flex flex-col">
        ...
        <section class="px-10">
          <div
            class="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 py-48 justify-center lg:py-16  lg:grid-cols-12"
          >
            <div class="mr-auto place-self-center lg:col-span-7">
              <h1
                class="max-w-2xl mb-1 text-6xl font-extrabold tracking-tight leading-none xl:text-6xl dark:text-white"
              >
                Лучший бустер игр в 
              </h1>
              <span class="max-w-2xl mb-4 text-6xl font-extrabold tracking-tight leading-none xl:text-6xl dark:text-white">СНГ</span>
              <p
                class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-2xl lg:text-xl dark:text-gray-400"
              >
        ...
        <div class="absolute bottom-0 mb-10 inline-flex gap-x-6 w-full pl-10">
          ...
          <div
            class="inline-flex text-base rounded-2xl text-gray-100 bg-orange-400 px-8 h-18 w-full mr-20"
          >
            <div class="gap-5 inline-flex" v-if="!boostisloading">
              ...
              <div class="flex flex-col pt-2.5">
                <span class="font-extrabold"
                  >Все отлично! Все обновления скачаны</span
                >
