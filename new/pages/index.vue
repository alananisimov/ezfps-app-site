  ...
  <main>
    ...
    <div class="flex flex-col pb-10 items-center justify-center">
        ...
        <div class="flex mt-4 space-x-3 md:mt-6">
            <a @click="" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Конфигурации</a>
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
           ...
           <a @click="start_execute" class="text-xl rounded-full bg-orange-400 px-16 py-4 font-semibold leading-6 text-gray-100 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" id="learn">Начать <span aria-hidden="true">→</span></a>
         </div>
