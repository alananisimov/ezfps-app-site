<template>
  <main>
     <div v-if="user.email" class="mx-auto max-w-7xl md:py-6 py-6 sm:px-12 lg:px-16">
...
<div class="grid grid-cols-3 grid-rows-2 gap-4">
   ...
   <div v-if="!user.email" class="items-center justify-center px-auto py-auto h-full w-full">
    <img src="/loading.svg" class="m-10 mx-auto my-auto mt-32">
    </div>
   </main>
</template>
