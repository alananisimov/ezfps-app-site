  ...
  <main>
    ...
    <div class="flex flex-col pb-10 items-center justify-center">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
           ...
           <button v-if="roleValue != 'user' | 'tguser'" type="button" @click="start_execute" id="successButton" data-modal-toggle="successModal" class="inline-flex items-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
