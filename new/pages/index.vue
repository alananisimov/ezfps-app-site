  ...
  <main>
    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
           ...
           <a class="text-xl rounded-full bg-orange-400 px-16 py-4 font-semibold leading-6 text-gray-100 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mx-32" id="learn">Начать <span aria-hidden="true">→</span></a>
         </div>
    </div>
</div>
