<template>
  <main>
     ...
     <div class="mx-auto max-w-2xl py-8 sm:py-24 lg:py-14 p-8 rounded-xl shadow-2xl flex items-center space-x-4 rounded-[60px]">
       
       <div class="text-center">
        
         <h1 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-900 sm:text-6xl">Оптимизируй свой ПК без проблем</h1>
         ...
         <div class="mt-10 flex items-center justify-center gap-x-6">
           ...
           <a href="#" class="text-xl rounded-full bg-orange-400 px-32 py-4 font-semibold leading-6 text-gray-100" id="learn">Начать <span aria-hidden="true">→</span></a>
         </div>
       </div>
     </div>
