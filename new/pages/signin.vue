  ...
  <span class="absolute px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">or</span>
                  ...
                  <div class="flex items-start">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="terms" class="font-light text-gray-500 dark:text-gray-300">Я принимаю <a class="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Правила и поглашения</a></label>
                      </div>
                  </div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Нет аккаунта? <NuxtLink to="/signup"><a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Зарегистрируйтесь</a></NuxtLink>
                  </p>
              </form>
          </div>
      </div>
