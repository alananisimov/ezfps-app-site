...
<h3 class="my-5 text-lg font-medium text-gray-900 dark:text-white">Выберите режим оптимизации:</h3>
                    <ul class="grid w-full gap-6 grid-cols-3">
                        <li>
                            <input name="mode" type="radio" id="easy-option" value="easy" class="hidden peer" @click="mode.value='easy'">
                        ...
                        <li>
                            <input name="mode" type="radio" id="medium-option" value="medium" class="hidden peer" @click="mode.value='medium'">
                        ...
                        <li>
                            <input name="mode" type="radio" id="hard-option" value="hard" class="hidden peer" @click="mode.value='hard'">
