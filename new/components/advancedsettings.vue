            ...
            <!-- Modal body -->
                ...
                <div class="grid gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="dota_path" id="dotapath" v-model="dota_path.value" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    </div>
                    <div>
                        <label for="cspath" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Путь к csgo</label>
                        <input type="text" name="cs_path" id="cspath" v-model="cs_path.value" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    </div>
